...
public class Agent extends Turtle {
    ...
    // Each agent has different parameters at creation (color is fixed)
    ...
    /**
     * Update (determine) active state
     * Uses the exact same logic as NetLogo:
    ...
    /**
     * Randomly determine jail term when arrested
     * Note: In NetLogo, jail-term = 0 means not in jail
     */
    public void setJailTerm(int jail_term) {
        // Ensure jail term is at least 1, since 0 means not in jail
